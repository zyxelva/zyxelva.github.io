...
var imgPath = "https://cdn.jsdelivr.net/gh/zyxelva/picgo/images/"; //图片访问路径   //填入你的路径，注意修改，参考：https://zhuanlan.zhihu.com/p/346643522
    ...
    const htmlEle = `<div class="card lozad" style="width:${imageWidth}px">
                  <div class="ImageInCard" style="height:${
                    ...
                    <a data-fancybox="gallery" href="${imgPath}${name}/${imgNameWithPattern}" data-caption="${imgName}" title="${imgName}">
                            <img class="lazyload" data-src="${imgPath}${name}/${imgNameWithPattern}" src="https://img-blog.csdnimg.cn/2022010710072165289.gif" onload="lzld(this)" lazyload="auto">
                        </a>
                  </div>
                </div>`;
    return htmlEle;
