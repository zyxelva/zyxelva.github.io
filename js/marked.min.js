...
!function (e, t) {
    ...
    var w = function () {
            ...
            return t.space = function (e) {
                ...
                if (e) return t = e[2].trim(), /#$/.test(t) && (u = k(t, "#"), !this.options.pedantic && u && !/ $/.test(u) || (t = u.trim())), {
                    type: "heading",
                    raw: e[0],
                    depth: e[1].length,
                    text: t,
                ...
                if (e) return e[3] && (e[3] = e[3].substring(1, e[3].length - 1)), {
                    ...
                    raw: e[0],
                    href: e[2] && e[2].replace(this.rules.inline._escapes, "$1"),
                    title: e[3] && e[3].replace(this.rules.inline._escapes, "$1")
                }
            }, t.table = function (e) {
                ...
                var u;
                if (u = (u = this.rules.inline.reflink.exec(e)) || this.rules.inline.nolink.exec(e)) return (e = t[(e = (u[2] || u[1]).replace(/\s+/g, " ")).toLowerCase()]) && e.href ? b(u, e, u[0], this.lexer) : {
                    type: "text",
                    raw: t = u[0].charAt(0),
                    text: t
                }
    ...
    var z = function () {
        ...
        return t.code = function (e, t, u) {
            ...
            return null === (e = g(this.options.sanitize, this.options.baseUrl, e)) ? u : (e = '<a href="' + D(e) + '"', t && (e += ' title="' + t + '"'), e + ">" + u + "</a>")
        }, t.image = function (e, t, u) {
            return null === (e = g(this.options.sanitize, this.options.baseUrl, e)) ? u : (e = '<div class="waterfall" id="encrypt-blog"><a href="' + e + '"  rel="example_group"     data-fancybox="images">' + '<img src="' + e + '" alt="' + u + '"', t && (e += ' title="' + t + '"'), e + (this.options.xhtml ? "/>" : ">") + '</a> </div>')
        }, t.text = function (e) {
            return e
        }, e
    }(), S = function () {
